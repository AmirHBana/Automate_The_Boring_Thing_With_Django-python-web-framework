...
from emails.models import Subscriber, Email, Sent, EmailTracking
...
def send_email(request):
    ...
    if request.method == 'POST':
        ...
        if email_form.is_valid():
            ...
            # Extract email address from the subscribers model in the selected email list
...
def track_open(request, unique_id):
    ...
    # Logic to store tracking information
...
def track_dashboard(request):
    ...
    return render(request, 'emails/track_dashboard.html', context=context)
...
def track_stats(request,pk):
    ...
    return render(request, 'emails/track_stats.html', context=context)